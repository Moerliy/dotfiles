...
I recommend using all the dotfiles together but it is possible to just use Doom Emacs with some additional personal changes.

** 1. Clone
If you don't have existing dofiles you can clone my hole repository (for that you should have a look at my README in my dotfile directory) or just Doome Emacs:
